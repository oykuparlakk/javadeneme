...
public class Hesap extends Banka{
	...
	public Hesap(int mevcutBakiye, String kisiBilgisi, int[] referansKodu) {
	 ...
	 static void IslemYap() {
		...
		while (true) {
			System.out.println("Çýkýþ yapmak istiyorsanýz 0'ý para yatýrmak için 1'i tuþlayýnýz:\n");
			int sayi;
			...
			if (sayi == 1) {
				...
				System.out.println("bankamýzý seçtiðiniz için teþekkür ederiz.");
				break;
			} else
				System.out.println("Yanlýþ bir sayý tuþladýnýz lütfen tekrar deneyin...");
		}
